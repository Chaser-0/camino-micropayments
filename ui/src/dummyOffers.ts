...
export const exampleData: Record<string, TTravelOffer> = {
  creteOffer: {
    ...
    addons: [
      {name: 'Breakfast', price: 0.00035, address: '0xdeadbeefdeadbeefdeadbeefdeadbeef', supplierAddress: '0xdeadbeefdeadbeefdeadbeefdeadbeef', supplierPercent: 10},
      {name: 'Spa day', price: 0.149, address: '0xdeadbeefdeadbeefdeadbeefdeadbeef', supplierAddress: '0xdeadbeefdeadbeefdeadbeefdeadbeef', supplierPercent: 10}
    ]
  },
  mallorcaOffer: {
