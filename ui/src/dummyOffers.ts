...
export const exampleData: Record<string, TTravelOffer> = {
	creteOffer: {
		...
		addons: [
			{ name: 'Breakfast', price: 0.00035, supplierId: 1 },
			{ name: 'Spa day', price: 0.149, supplierId: 1, },
			{ name: 'Bike excursion', price: 0.00035, supplierId: 2 },
			{ name: 'Wine tasting', price: 0.149, supplierId: 2 }
		]
	},
	mallorcaOffer: {
